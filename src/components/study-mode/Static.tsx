		...
		<section className="bg-neutral-0 grid gap-4 px-4 py-5 border border-color border-r-3 border-b-3 rounded-2xl ">
			...
			<div className="grid grid-cols-[1fr_1fr_100px] border border-color rounded-xl overflow-hidden">
				<p className="text-base/[1.2] font-medium p-5 col-span-2 grid gap-8">
					Total cards
					<span className="text-2xl/[1.2] font-bold">{flashcards ? flashcards.length : 0}</span>
				</p>
			...
			<div className="grid grid-cols-[1fr_1fr_100px] border border-color rounded-xl overflow-hidden">
				<p className="text-base/[1.2] font-medium p-5 col-span-2 grid gap-8">
					Mastered
					<span className="text-2xl/[1.2] font-bold">{mastered ? mastered : 0}</span>
				</p>
			...
			<div className="grid grid-cols-[1fr_1fr_100px] border border-color rounded-xl overflow-hidden">
				<p className="text-base/[1.2] font-medium p-5 col-span-2 grid gap-8">
					In Progress
					<span className="text-2xl/[1.2] font-bold">{inProgress ? inProgress : 0}</span>
				</p>
			...
			<div className="grid grid-cols-[1fr_1fr_100px] border border-color rounded-xl overflow-hidden">
				<p className="text-base/[1.2] font-medium p-5 col-span-2 grid gap-8">
					Not Started
					<span className="text-2xl/[1.2] font-bold">{notStarted ? notStarted : 0}</span>
				</p>
