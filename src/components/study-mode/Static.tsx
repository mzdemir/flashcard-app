		...
		<section className="bg-neutral-0 grid gap-4 px-4 py-5 border border-color border-r-3 border-b-3 rounded-2xl ">
			...
			<div className="grid grid-cols-[1fr_1fr_100px] border border-color rounded-xl overflow-hidden">
				<p className="text-preset-4 font-medium p-5 col-span-2 grid gap-8">
					Total cards
					<span className="text-preset-1 font-bold">{flashcards.length}</span>
				</p>
			...
			<div className="grid grid-cols-[1fr_1fr_100px] border border-color rounded-xl overflow-hidden">
				<p className="text-preset-4 font-medium p-5 col-span-2 grid gap-8">
					Mastered
					<span className="text-preset-1 font-bold">{mastered}</span>
				</p>
			...
			<div className="grid grid-cols-[1fr_1fr_100px] border border-color rounded-xl overflow-hidden">
				<p className="text-preset-4 font-medium p-5 col-span-2 grid gap-8">
					In Progress
					<span className="text-preset-1 font-bold">{inProgress}</span>
				</p>
			...
			<div className="grid grid-cols-[1fr_1fr_100px] border border-color rounded-xl overflow-hidden">
				<p className="text-preset-4 font-medium p-5 col-span-2 grid gap-8">
					Not Started
					<span className="text-preset-1 font-bold">{notStarted}</span>
				</p>
